...
class BboxCalculator:
    @staticmethod
    def measure_aspect_ratios(bboxes: FloatArray) -> FloatArray:
        """
    ...
    def _compute_intersection_area(
        ...
        Returns:
        ---------
        tuple[FloatArray, FloatArray, FloatArray]: Intersection area, area of boxes1, and area of boxes2 of shape (N, M).
        """
    ...
    def compute_min_intersection_ratio(
        ...
        Returns:
        ---------
        FloatArray: Array of minimum intersection ratios of shape (N, M).
        """
    ...
    def compute_iou(
        ...
        Returns:
        ---------
        FloatArray: Array of IoU values of shape (N, M).
        """
    ...
    def compute_saiou(
        ...
        Returns:
        ---------
        FloatArray: Array of soft IoU values of shape (N, M).
        """
    ...
    def compute_diou(
        ...
        Returns:
        ---------
        FloatArray: Array of DIoU values of shape (N, M).
        """
    ...
    def compute_ciou(
        ...
        Returns:
        ---------
        FloatArray: Array of CIoU values of shape (N, M).
        """
    ...
    def compute_giou(
        ...
        Returns:
        ---------
        FloatArray: Array of GIoU values of shape (N, M).
        """
        intersection, area1, area2 = BboxCalculator._compute_intersection_area(boxes1, boxes2)
    ...
    def _apply_buffer(
        ...
        Returns:
        ---------
        FloatArray: Array of buffered bounding boxes of shape (N, 4).
        """
    ...
    def compute_biou(
        ...
        Returns:
        ---------
        FloatArray: Array of buffered IoU values of shape (N, M).
        """
    ...
    def compute_soft_biou(
        ...
        Returns:
        ---------
        FloatArray: Array of soft BIoU values of shape (N, M).
        """

        def expand_bboxes(bboxes: FloatArray, confidences: FloatArray, k: float) -> tuple[FloatArray, FloatArray, FloatArray, FloatArray]:
            w = bboxes[..., 2] - bboxes[..., 0]
            h = bboxes[..., 3] - bboxes[..., 1]
        ...
        def compute_area(x1: FloatArray, y1: FloatArray, x2: FloatArray, y2: FloatArray) -> FloatArray:
    ...
    def get_box_centers(
        ...
        Returns:
        ---------
        FloatArray: Array of shape (N, 2) containing the center coordinates.
    ...
    def compute_cdf_from_matrix(
        ...
        Returns:
        ---------
        tuple[FloatArray, FloatArray]: tuple containing the sorted values and the cumulative relative frequencies.

        - FloatArray: Array of shape (N, 2) containing the sorted values.
        - FloatArray: Array of shape (N, 2) containing the cumulative relative frequencies.
        """
